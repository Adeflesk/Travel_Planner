"""
app/models/journey_segment.py - Journey segment SQLAlchemy model
...
class JourneySegment(Base):
    ...
    activities = relationship("Activity", back_populates="segment")
    expenses = relationship("Expense", back_populates="segment")
